...
public class ReverseInteger {
     ...
     */
    public static int reverseByDaoHuei(int x) {
    ...
    /*
     * Author: @ballm06m06 Qusetion: Reverse Integer Description: Given a signed
     * 32-bit integer x, return x with its digits reversed. If reversing x causes
